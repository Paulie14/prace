...
In this chapter we develope mathematical background for our model.
...
of a fracture in 2d,cross-section of a channel in 1d). The total flux boundary condition $g_{dN}$ is considered outward.
