...
In this chapter we derive the mixed-hybrid model for solving both velocity and pressure and we develop a~mathematical background.
...
At the end we provide several numerical tests computed using our implementation in Flow123d.
...
We consider a~serie of simple structured meshes of a~triangle domain with nodes $[0,0],\,[10,0]$ and $[0,10]$.
