...
% % i & h & \multicolumn{2}{c|}{$\|p-p_h\|_{L_2(\Omega)}$} & $N^{reg}_{dofs}$ & $N^{enr}_{dofs}$\\ [3pt] \hline
% \multicolumn{2}{c|}{} & \multicolumn{2}{c|}{Test case 3} & \multicolumn{2}{c|}{Test case 4} & \multicolumn{2}{c}{}\\ [3pt] %\midrule
% i & h & $\|p-p_h\|_{L_2(\Omega)}$ & rate & $\|p-p_h\|_{L_2(\Omega)}$ & rate & $N^{reg}_{dofs}$ & $N^{enr}_{dofs}$ \\ [3pt] \midrule
