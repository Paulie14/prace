...
The background research on various XFEMs is provided in the first part of Chapter~\ref{chap:xfem_pressure}.
It is then followed by a~well aquifer pressure model in which the singular enrichment is applied by the means of XFEM.
