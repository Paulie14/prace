...
Since the interpolant is built using the regular FE shape functions, the additional computational costs lie in the evaluation of $s(\bx_\beta)$, $\beta\in\mathcal{I}^e$,
