...
The first part of this section is devoted to a~theoretical analysis, the later part presents numerical validation of obtained estimates.
...
\[
    R_o \sim \sqrt{\frac{\pi}{6}} h/\norm{p_{reg} - \Pi p_{reg}}_{H^1(\Omega)} \sim 0.32
\]
