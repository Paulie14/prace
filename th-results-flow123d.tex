...
\begin{figure}[!htb]
    \centering
    \subfloat[singularity and zero source]{
    \includegraphics[width=0.498\textwidth]{\results tc-23-error.pdf} }
    %\hspace{5pt}
    \subfloat[singularity and source term $f=U\sin(\omega x)$]{
...
\toprule
\multicolumn{2}{c|}{} & \multicolumn{2}{c|}{ SGFEM, $f=0$} & \multicolumn{2}{c|}{SGFEM} & \multicolumn{2}{c}{$\textrm{MHFEM}_{reg}$}\\ [3pt] %\midrule
...
%     \item TC2-e: $f=U\sin(\omega x)$, no singularity
\end{itemize}
