...
%TODO:
Recently the Multi Level Monte Carlo (MLMC) is being developed extensively and it is attractive also
in underground procsesses simulations, where it used in uncertainty quantification analysis in DFN.
...
\begin{enumerate}
    ...
    \item If any $w_i$ is less than $-\epsilon$ (see the definition bellow), there is no intersection, return empty IP. \fig{fig:1d2d_cases}, (a).          
