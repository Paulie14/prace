...
%TODO: 2d-2d
At first, the algorithms for 1d-2d, 1d-3d and 2d-3d intersections of simplices are described.
...
in the sign check for the permuted inner products, second, it is used for the topologic check on the line. Only these two kinds of geometric predicates are used 
...
% The computation of IP consists of three stages: a~calculation of side-tetrahedron ICs (Section \ref{sec:sides}), 
% a~calculation of edge-triangle ICs (Section~\ref{sec:edges}), an ordering of ICs (Section~\ref{sec:ordering}).
...
\begin{figure}%[!htb]
  \begin{center}        
    \includegraphics[width=0.3\textwidth]{\figpathins edge_faces_color.pdf}
  \end{center}
